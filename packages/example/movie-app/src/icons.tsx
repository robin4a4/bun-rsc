/**
 * Rendering svgs as jsx is not a good practice, we should use svg sprites instead,
 * see: https://benadam.me/thoughts/react-svg-sprites/
 *
 * But for the sake of simplicity I copy pasted the icons from https://heroicons.com/mini.
 * I could have installed the package but I only need a few icons and wanted to be able
...
export function ChevronBottomIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
